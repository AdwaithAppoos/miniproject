...
namespace TLPAS
{
    ...
    {
        SqlConnection con = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\adwai\Documents\mydatabase.mdf;Integrated Security=True;Connect Timeout=30");
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            con.Close();
            this.Hide();
            MessageBox.Show("Combination Successfully Updated");
